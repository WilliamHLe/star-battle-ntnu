...
object Configuration {
    ...
    init {
        ...
        slides.add(ImageSlideshowComponent("tutorial3.png", "When you have positioned your UFO and target at your desired place you click on the 'End Turn' button at the bottom. Now you will see that the status on top will change and you will have to wait for the your opponent to end their turn. There is also a timer at the bottom screen, auto-ending the turn if run out."))
        ...
        skins.add(SkinComponent("ufo_boss.png", "Thug ufo"))
